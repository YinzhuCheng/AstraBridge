...
| Versioned cross-provider protocol schemas and generated types | `astrabridge_sidecar.protocol` | `agent_orchestration_contract.py`, `task_graph_contract.py`, and inline Desktop types remain compatibility bridges until the stability plan migrates their consumers; generated AstraBridge types must remain separate from Codex/app-server generated types. | Protocol schema fixtures, Python/TypeScript generation freshness, migration tests, and this boundary audit. |
