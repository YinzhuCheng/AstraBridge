...
LangString chooseMaintenanceOption ${LANG_ENGLISH} "Choose the maintenance operation."
...
LangString newerVersionInstalled ${LANG_ENGLISH} "A newer version of ${PRODUCTNAME} is already installed. Select the operation you want to perform and click Next to continue."
LangString older ${LANG_ENGLISH} "older"
LangString olderOrUnknownVersionInstalled ${LANG_ENGLISH} "An $R4 version of ${PRODUCTNAME} is installed. It is recommended to uninstall the current version before installing this one."
LangString silentDowngrades ${LANG_ENGLISH} "Downgrades are disabled for this installer. Please use the graphical installer.$\n"
...
LangString deleteAppData ${LANG_ENGLISH} "Delete AstraBridge data only (does not touch official Codex)"
