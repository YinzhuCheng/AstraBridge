...
GLM_TOOL_POLICY = ToolPolicy(
    command_execution_status="partial_no_command_execution",
    command_execution_note="Provider-backed code-agent turns reached completed terminal state, but no commandExecution event has been observed yet.",
)
...
_PROFILES: tuple[ProviderProfile, ...] = (
    ProviderProfile(
        ...
        reasoning_policy=ReasoningPolicy(
            ...
            native_supported_levels=("none", "low", "medium", "high", "xhigh"),
            native_default_level="medium",
        ),
    ...
    ProviderProfile(
        ...
        capabilities=ProviderCapabilities(True, True, False, False, False, True, False, False, 1_000_000, 384_000),
        reasoning_policy=ReasoningPolicy(
            mode="reasoning_content",
            allow_cross_provider_replay=False,
            preserve_for_tool_turns=True,
            supported_levels=("off", "high", "xhigh"),
            default_level="high",
            native_supported_levels=("none", "low", "medium", "high", "max"),
            native_default_level="high",
        ),
    ...
    ProviderProfile(
        ...
        capabilities=ProviderCapabilities(True, True, False, True, False, True, False, False, 1_000_000, 64_000),
        reasoning_policy=ReasoningPolicy(
            mode="enable_thinking",
            allow_cross_provider_replay=False,
            supported_levels=("off", "minimal", "low", "medium", "high", "xhigh"),
            default_level="medium",
            native_supported_levels=("none", "minimal", "low", "medium", "high"),
            native_default_level="medium",
        ),
        tool_policy=DEFAULT_TOOL_POLICY,
    ...
    ProviderProfile(
        ...
        capabilities=ProviderCapabilities(True, True, False, True, False, True, False, False, 1_048_576, 1_048_576),
        reasoning_policy=ReasoningPolicy(
            mode="reasoning_content",
            allow_cross_provider_replay=False,
            preserve_for_tool_turns=True,
            supported_levels=("low", "high", "xhigh"),
            default_level="xhigh",
            native_supported_levels=("low", "high", "max"),
            native_default_level="max",
        ),
        tool_policy=DEFAULT_TOOL_POLICY,
        edit_policy=STRUCTURED_EDIT_POLICY,
        context_policy=ContextPolicy(default_input_modalities=("text", "image", "video"), advertised_context_window=1_048_576),
        fallback_policy=FallbackPolicy(fallback_models=("kimi-k3", "kimi-k2.7-code", "kimi-k2.6")),
        safety_policy=ProviderSafetyPolicy(
    ...
    ProviderProfile(
        ...
        tool_policy=GLM_TOOL_POLICY,
        edit_policy=STRUCTURED_EDIT_POLICY,
        context_policy=ContextPolicy(default_input_modalities=("text",), advertised_context_window=1_000_000),
