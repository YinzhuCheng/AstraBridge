    ...
    def _browser_smoke_preset(self, preset: str) -> dict[str, Any]:
        ...
        if preset == BROWSER_SMOKE_PRESET_NATIVE_KERNEL_WORKFLOW:
            return {
                ...
                "final_assertions": [
                    ...
                    {"type": "expect_selector", "selector": "[data-testid='task-fact-checkpoints']", "timeout_ms": 12000},
                    ...
                    {"type": "expect_selector", "selector": "[data-testid='workflow-fact-checkpoints']", "timeout_ms": 12000},
        ...
        if preset == BROWSER_SMOKE_PRESET_PROVIDER_SWITCH_WORKFLOW:
            return {
                ...
                "final_assertions": [
                    ...
                    {"type": "expect_selector", "selector": "[data-testid='workflow-fact-lanes']", "timeout_ms": 12000},
                    {"type": "expect_selector", "selector": "[data-testid='workflow-fact-checkpoints']", "timeout_ms": 12000},
                    {"type": "expect_selector", "selector": "[data-testid='workflow-fact-commands']", "timeout_ms": 12000},
                    {"type": "expect_selector", "selector": "[data-testid='workflow-fact-diagnostics']", "timeout_ms": 12000},
                    {"type": "expect_selector", "selector": "[data-testid='workflow-fact-recovery']", "timeout_ms": 12000},
        ...
        return {
            ...
            "actions": [
                ...
                {"type": "expect_selector", "selector": "[data-testid='checkpoint-preview-panel']", "timeout_ms": 12000},
                {"type": "click_selector", "selector": "[data-testid='setup-back-to-chat']", "timeout_ms": 12000},
            ...
            "final_assertions": [
                ...
                {"type": "expect_selector", "selector": "[data-testid='composer-send']", "timeout_ms": 12000},
                {"type": "expect_selector", "selector": "[data-testid='status-panel-goal']", "timeout_ms": 12000},
                {"type": "expect_selector", "selector": "[data-testid='task-workflow-facts']", "timeout_ms": 12000},
                {"type": "expect_selector", "selector": "[data-testid='task-fact-lanes']", "timeout_ms": 12000},
                {"type": "expect_selector", "selector": "[data-testid='task-fact-checkpoints']", "timeout_ms": 12000},
                {"type": "expect_selector", "selector": "[data-testid='task-fact-handoffs']", "timeout_ms": 12000},
                {"type": "expect_selector", "selector": "[data-testid='task-fact-backend']", "timeout_ms": 12000},
