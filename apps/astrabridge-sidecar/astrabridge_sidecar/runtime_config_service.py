    ...
    def _normalize_profile(
        ...
        *,
        ...
        return {
            ...
            "supports_search_tool": merged_profile.get("supports_search_tool"),
            "native_web_search_support": merged_profile.get("native_web_search_support"),
            "tool_web_search_support": merged_profile.get("tool_web_search_support"),
            "mcp_web_support": merged_profile.get("mcp_web_support"),
            "web_smoke_status": merged_profile.get("web_smoke_status"),
            "citation_quality": merged_profile.get("citation_quality"),
            "last_web_verified_at": merged_profile.get("last_web_verified_at"),
            "tool_mode": merged_profile.get("tool_mode"),
            "multi_agent_version": merged_profile.get("multi_agent_version"),
            "use_responses_lite": merged_profile.get("use_responses_lite"),
            "supports_mcp_tools": merged_profile.get("supports_mcp_tools"),
            "mcp_tool_call_policy": merged_profile.get("mcp_tool_call_policy"),
            "mcp_verified_servers": merged_profile.get("mcp_verified_servers"),
            "mcp_smoke_status": merged_profile.get("mcp_smoke_status"),
            "mcp_tool_argument_validation": merged_profile.get("mcp_tool_argument_validation"),
            "codex_builtin_tools": merged_profile.get("codex_builtin_tools"),
